@echo off
set COMPONET_NAME=XDS-x86 Library-Manager
...
echo xc =p src\xlib.prj %MAKE_OPTIONS%  1>  "%LOG_DIR%\%TASK_NAME%.log" 2>&1
xc =p src\xlib.prj  %MAKE_OPTIONS%      1>> "%LOG_DIR%\%TASK_NAME%.log" 2>>&1
