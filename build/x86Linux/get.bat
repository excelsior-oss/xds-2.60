...
call :lbl_MakeBuildDir "enduser\xds\C\x86"
call :lbl_MakeBuildDir "enduser\xds\include\C"
call :lbl_MakeBuildDir "enduser\xds\include\x86"
...
call :lbl_MakeBuildDir "enduser\xds\def\ts"
...
if not "%XDS_BUILD_DIR%" == "."  for %%i in (maketgz.bat,setenv.bat,README.md) do call :lbl_XCopyFiles "build\x86Linux\%%i"  ""
if not "%XDS_BUILD_DIR%" == "."  for %%i in (build.sh,makexds-c.sh,makexds-x86.sh,pack-xds.sh,setenv.sh)    do call :lbl_XCopyFiles "build\x86Linux\%%i"  ""
...
rem ============================================= API 
call :lbl_XCopyFiles "api\enduser\linux\*"  "enduser\xds\"  || exit /B 1
...
rem ============================================= Licence files  
call :lbl_XCopyDir "misc\licenses\linux"  "enduser\xds\licenses\" /Y /E /Q  || exit /B 1
...
call :lbl_XCopyFiles "misc\samples\buildx86"  "enduser\xds\samples\"  || exit /B 1      
