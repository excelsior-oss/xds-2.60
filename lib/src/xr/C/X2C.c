...
#include <bits/sigcontext.h>
  static struct user_fpregs_struct sigfpe_fpu_state;
#else
#include <linux/user.h>
#include <asm/sigcontext32.h>
  static struct user_i387_struct sigfpe_fpu_state;
#endif /* __GLIBC_PREREQ(2,13) */
#endif /* _linux */
...
#if defined(__linux__) && defined(__i386__) && (defined(X2C_native_library) || defined(X2C_native_setjump))
        stk_up  = 0;
        ss_offs = -1;
